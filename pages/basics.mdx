---
title: Betwatch 101 - Betwatch Guides
description: Tips and tricks for using the Betwatch odds comparison platform.
---

# Betwatch 101

The Betwatch platform is designed to be simple and easy to use. There are a couple of tips and tricks that may not be obvious at first glance, so we have put together this guide to help you get the most out of the platform.
